...
Public Class PatientEDB
    ...
    Function GetPatientList(active As Boolean) As List(Of PatientE)
        ...
        Dim query As String = "SELECT [Id],[First Name],[Last Name],[Others Name],[Address],[Parish]
                              ,[Sex],[Date OB],[Phone1],[Phone2],[Email],[DoctorNotes],[Paper Record]
    ...
    '########### INSERT PATIENT ####################
    Sub InsertEmployer(ByVal patient As PatientE)
        ...
        Using connection As New SqlConnection(conString)
            Using command As New SqlCommand(query, connection)
                ...
                command.Parameters.AddWithValue("@OthersName", SqlDbType.VarChar).Value = patient.OthersName
